    ...
    <div class="login-layout__wrapper">
      <div class="login-layout">
        ...
        <div class="form-field">
          <label for=""
            >Логин<input v-model="register_username" type="text"
          /></label>
        </div>
        <div class="form-field">
          <label for=""
            ...
            <font-awesome-icon
              :icon="showRegisterPassword ? 'eye-slash' : 'eye'"
              @click="toggleInputType('register')"
          /></label>
        </div>
        ...
        <div class="form-field">
          <label for=""
            >Логин<input v-model="auth_username" type="text"
          /></label>
        </div>
        <div class="form-field">
          <label for=""
            ...
            <font-awesome-icon
              :icon="showAuthPassword ? 'eye-slash' : 'eye'"
              @click="toggleInputType('auth')"
          /></label>
        </div>
